package components.forms.AccountForm;
...
public class TextArea extends BaseComponent {
    ...
    private static final String TEXT_AREA_LOCATOR_PATTERN = "//label[contains(.,'%s')]/ancestor::div[contains(@class,'uiInput')]//textarea";
